...
from torch_mcpu.openreg import get_mcpu_view_from_cpu_tensor


class TestGetMcpuViewFromCpuTensor(TestCase):
    """Tests for get_mcpu_view_from_cpu_tensor.
    ...
    def test_returns_mcpu_tensor(self):
        ...
        mcpu = get_mcpu_view_from_cpu_tensor(cpu)
    ...
    def test_rejects_non_cpu_tensor(self):
        ...
        with self.assertRaises(Exception):
            get_mcpu_view_from_cpu_tensor(mcpu_tensor)

    def test_rejects_non_tensor(self):
        with self.assertRaises(Exception):
            get_mcpu_view_from_cpu_tensor(42)  # type: ignore[arg-type]
